...
class getSpecialityRepositoryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'SpecialityRepository.php';

        return $container->privates['App\\Repository\\SpecialityRepository'] = new \App\Repository\SpecialityRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
