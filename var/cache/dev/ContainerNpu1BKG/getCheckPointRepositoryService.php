 ...
 */
class getCheckPointRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CheckPointRepository' shared autowired service.
     *
     * @return \App\Repository\CheckPointRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CheckPointRepository.php';

        return $container->privates['App\\Repository\\CheckPointRepository'] = new \App\Repository\CheckPointRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
